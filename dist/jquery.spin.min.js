...
(function(i){"function"==typeof define&&define.amd?define(["jquery","spin"],i):i(jQuery,spin.js.Spinner)})(function(i, o){i.fn.spin=function(t){var e={lines:12,length:7,width:5,radius:10,color:"#fff",speed:1,trail:100,shadow:!0,bgColor:"Gray",opacity:4};return this.each(function(){var n=i(this),s=n.data();if(s.spinner&&(s.spinner.stop(),delete s.spinner,n.find(".loadingBG").remove()),t!==!1){t=t||{},t=i.extend({},e,t);var a=i("<div>");a.addClass("loadingBG"),a.css({display:"none",filter:"alpha(opacity="+10*t.opacity+")",opacity:t.opacity/10,"-ms-filter":"progid:DXImageTransform.Microsoft.Alpha(opacity="+10*t.opacity+")",position:"absolute","z-index":9999,top:"absolute"===n.css("position")?0:n.position().top-1,left:"absolute"===n.css("position")?0:n.position().left,"background-color":""+t.bgColor,width:n.outerWidth(),height:0===n.outerHeight()?"100%":n.outerHeight()+1,marginTop:n.css("marginTop"),marginRight:n.css("marginRight"),marginBottom:n.css("marginBottom"),marginLeft:n.css("marginLeft")}),delete t.bgColor,delete t.opacity,s.spinner=new o(t).spin(this),a.prependTo(n).show()}}),this}});